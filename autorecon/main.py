...
async def run():
	...
	parser.add_argument('--enable-ai', action='store_true', help='Enable AI-powered penetration testing capabilities using Ollama. Default: %(default)s')
	parser.add_argument('--ai-model', action='store', type=str, default='llama3.1', help='AI model to use with Ollama. Default: %(default)s')
	parser.add_argument('--ollama-url', action='store', type=str, default='http://localhost:11434', help='Ollama server URL. Default: %(default)s')
	parser.add_argument('--ai-request', action='store', type=str, help='Natural language request for AI-powered pentesting (e.g., "get me info on John Smith who lives in Seattle")')
	parser.add_argument('--target-name', action='store', type=str, help='Name of person/organization to investigate for AI-powered OSINT')
	parser.add_argument('--target-location', action='store', type=str, help='Location information for AI-powered targeting')
	parser.add_argument('--company-name', action='store', type=str, help='Company name for AI-powered social engineering')
